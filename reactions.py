...
reaction['D(He3,P)He4'] = reac_class()
reaction['D(He3,P)He4'].in1 = he3
reaction['D(He3,P)He4'].in2 = deuteron
reaction['D(He3,P)He4'].prod1 = proton
reaction['D(He3,P)He4'].prod2 = he4
reaction['D(He3,P)He4'].coeff_reac = [5.51036e-10, 6.41918e-3, -2.02896e-3, -1.9108e-5,  1.35776e-4, 0, 0]

reaction['D(T,n)He4'] = reac_class()
reaction['D(T,n)He4'].in1 = deuteron
reaction['D(T,n)He4'].in2 = triton
reaction['D(T,n)He4'].prod1 = neutron
reaction['D(T,n)He4'].prod2 = he4
reaction['D(T,n)He4'].coeff_reac = [1.17302e-9 , 1.51361e-2, 7.51886e-2, 4.60643e-3,  1.35000e-2, -1.06750e-4, 1.36600e-5]
